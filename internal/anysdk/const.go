...
const (
	...
	// ExtensionKeyEnvVar names an environment variable that resolves a server
	// variable when no explicit value is supplied.
	ExtensionKeyEnvVar string = "x-stackQL-envVar"
