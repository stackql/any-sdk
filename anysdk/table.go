	...
	if cd.Node != nil {
		...
		case *sqlparser.ConvertExpr:
			if nt.Type != nil && nt.Type.Type != "" {
				return newSchemaWithoutParent(&openapi3.Schema{Type: nt.Type.Type}, cd.Schema.getService(), cd.Schema.getKey(), "")
			}
		// TODO: make this intelligent
		case *sqlparser.FuncExpr:
			return newSchemaWithoutParent(&openapi3.Schema{Type: "string"}, cd.Schema.getService(), cd.Schema.getKey(), "")
		}
